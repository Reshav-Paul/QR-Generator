...
public class KanjiCharacterCountIndicator implements CharacterCountIndicator {
    private int _characterCount;
    private QRCodeVersion _qrCodeVersion;

    public KanjiCharacterCountIndicator(int characterCount, QRCodeVersion qrCodeVersion) {
